...
Application.prototype._generateGeneralMenu = function() {
    ...
    b.setAttribute("src", "content/images/img/vertical_flow.png");
    c.appendChild(b);
    c.appendChild(f);
    ...
    c.onclick = function() {
        ...
        if (j.style.display == "none") {
            ...
            this.childNodes[0].setAttribute("src", "content/images/img/vertical_flow.png")
        } else {
            j.style.display = "none";
            this.childNodes[0].setAttribute("src", "content/images/img/horizontal_flow.png")
        }
    };
    ...
    this._addMenuItem(this._tools_ul1, "Modify color", function(x) {
        ...
        var C = new Array(parseInt(z.slice(0, 2), 16), parseInt(z.slice(2, 4), 16), parseInt(z.slice(4, 6), 16)); /*http://www.jrromero.net/tools/jsUML2*/
...
Application.prototype._addMenuItem = function(a, g, f, k, b) {
    ...
    if (b) {
        ...
        c.setAttribute("src", "content/images/img/" + b + ".png");
        h.appendChild(c)
    }
    e.appendChild(j);
    h.appendChild(e);
