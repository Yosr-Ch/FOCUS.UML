...
import com.ensi.pcd.repository.search.ProjectSearchRepository;
...
public class ProjectResource {
    ...
    public ResponseEntity<Project> createProject(@Valid @RequestBody Project project) throws URISyntaxException {
        ...
        /*project.setUser(userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).get());*/
    ...
    public ResponseEntity<List<Project>> getAllProjects(Pageable pageable)
        ...
        /*Page<Project> page = projectRepository.findAllForCurrentUser(pageable);*/
        Page<Project> page;
        if (SecurityUtils.isCurrentUserInRole(AuthoritiesConstants.ADMIN)) {
            ...
            page = projectRepository.findAllForCurrentUser(pageable);
